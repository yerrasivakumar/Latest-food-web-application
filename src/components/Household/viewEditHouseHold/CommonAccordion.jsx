...
import { Box, Button, FormControl, FormHelperText, Grid, IconButton, InputLabel, MenuItem as MuiMenuItem, Select, TextField } from "@mui/material";
...
const CommonAccordion = ({ memberIndex,page,familyCode, ...props }) => {
  ...
  const formik = useFormik({
    initialValues: {
      participantCode:
      memberIndex >= 9 ? familyCode + `${memberIndex+1}`  :familyCode +  `0${memberIndex+1}`,
      // participantId:memberIndex,
      headOfFamily:
        false,
      firstName: appState?.houseHold?.participants?.[memberIndex]?.firstName || "",
      familyName: appState?.houseHold?.participants[memberIndex]?.familyName || "",
      ...
      genderId: appState?.houseHold?.participants?.[memberIndex]?.genderId || "",
      ...
      occupationId: appState?.houseHold?.participants?.[memberIndex]?.occupationId || "",
    },
    enableReinitialize: true,
    onSubmit: (values) => {
      console.log('Formik Values:', values); 
      dispatch(updatDetails({ values:{...values,updatedDate:moment()['_d'].toISOString(),householdId: appState?.houseHold?.householdId,dob:moment(values.dob['$d']).format('YYYY-MM-DDTHH:mm:ss.SSS[Z]')}, memberIndex }));
      ...
      updatDetails({
        values: {
          ...
          dob: appState?.houseHold?.participants[memberIndex]?.dob?.length
            ?  formik?.values.dob
            : moment(formik.values.dob["$d"]).format("YYYY-MM-DDTHH:mm:ss.SSS[Z]")
    ...
    <div key={memberIndex}>
      <Accordion {...props}>
        <AccordionSummary
          ...
          id="panel2a-header"
          sx={page!=='view' ?{ marginTop: "-5px", marginBottom: "-5px" }:{}}
        >
          <Box
            display={"flex"}
            ...
            >
              ...
              <Grid item sm={12} xs={12} md={6} lg={4}>
                ...
                >
                  ...
                  <div dir={lang==='ar'?"rtl":""}>
                  <FormHelperText style={formik.touched.genderId && formik.errors.genderId ? { display: "block", color: "#d32f2f"}
                  : { display: "none" }
                  }>{t('Gender Required')}</FormHelperText>
                ...
                >
                  ...
                  <FormControl size="small" fullWidth name='dob'>
                    ...
                    <DatePicker
                      ...
                      slotProps={{ textField: { size: "small", helperText: formik.touched.dob &&
                      formik.errors.dob &&
                      formik.errors.dob,error:formik.touched.dob && formik.errors.dob ? true : false } }}
                      renderInput={(params) => (
                        <TextField
              ...
              <Grid item sm={12} xs={12} md={6} lg={4}>
                ...
                >
                  ...
                  <div dir={lang==='ar'?"rtl":""}>
                  <FormHelperText 
                  style={formik.touched.academicLevelId && formik.errors.academicLevelId ? { display: "block", color: "#d32f2f"}
                  : { display: "none" }
                  }
                  >{t('AcedemicLevel Required')}</FormHelperText>
                  </div>
                  </FormControl>
                </Box>
              </Grid>
              <Grid item sm={12} xs={12} md={6} lg={4}>
                ...
                >
                  ...
                  <div dir={lang==='ar'?"rtl":""}>
                  <FormHelperText style={formik.touched.maritalStatusId && formik.errors.maritalStatusId ? { display: "block", color: "#d32f2f"}
                  : { display: "none" }
                  } >{t('Marital Status Required')}</FormHelperText>
                  </div>
                  </FormControl>
                </Box>
              </Grid>
              <Grid item sm={12} xs={12} md={6} lg={4}>
                ...
                >
                  ...
                  <div dir={lang==='ar'?"rtl":""}>
                  <FormHelperText style={formik.touched.relativeRelationId && formik.errors.relativeRelationId ? { display: "block", color: "#d32f2f"}
                  : { display: "none" }
                  } >{t('Relationship Required')}</FormHelperText>
                  </div>
                  </FormControl>
                </Box>
              </Grid>
              <Grid item sm={12} xs={12} md={6} lg={4}>
                ...
                >
                  ...
                  <div dir={lang==='ar'?"rtl":""}>
                  <FormHelperText style={formik.touched.occupationId && formik.errors.occupationId ? { display: "block", color: "#d32f2f"}
                  : { display: "none" }
                  }>{t('Occupation Required')}</FormHelperText>
                  </div>
                  </FormControl>
                </Box>
              </Grid>
